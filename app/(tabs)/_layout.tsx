...
const styles = StyleSheet.create({
  ...
  modalCard: {
    ...
    left: 12,
    right: 12,
    backgroundColor: "rgba(7, 26, 62, 0.98)",
    borderRadius: 24,
    paddingTop: 18,
    paddingBottom: 16,
  ...
  logText: { color: "#C8D8EC", fontSize: 11, fontWeight: "600", letterSpacing: 0.6 },
  logTextActive: { color: "#001753" },
  logBtn: { marginTop: 4, backgroundColor: "#123A6C", borderRadius: 16, paddingVertical: 10, alignItems: "center" },
  logBtnDim: { opacity: 0.5 },
  logBtnText: { color: "#E8F4FF", fontSize: 12, fontWeight: "600", letterSpacing: 0.6 },
  logBtnTextDim: { color: "#6F8FB0" },
  saveBtn: {
    flexDirection: "row", alignItems: "center", justifyContent: "center", marginTop: 14, marginHorizontal: 20, paddingVertical: 11, borderRadius: 24, backgroundColor: "#1A5FA8",
    shadowColor: "#1A5FA8", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.45, shadowRadius: 10, elevation: 6,
  },
  saveBtnDim: { backgroundColor: "#0C1F3A", shadowOpacity: 0, elevation: 0 },
